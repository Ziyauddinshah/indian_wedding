      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 flex-1 max-w-2xl">
            ...
            {/* Logo */}
            <Link href="/partner/dashboard" className="hidden lg:flex items-center gap-2 group">
              <div className="p-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl group-hover:rotate-12 transition-transform">
