...
export default function PartnerSidebar({ onCloseMobile }: PartnerSidebarProps) {
  const pathname = usePathname();

  // Handle link click - closes mobile sidebar when a link is clicked
  ...
  return (
    <aside className="sticky top-0 z-50 h-full w-64 bg-gradient-to-b from-white to-blue-50 border-r border-blue-200 shadow-xl flex flex-col">
      ...
      {/* Partner Status */}
      <div className="p-6 border-t border-blue-100 bg-white/50">
